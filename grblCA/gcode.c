...
uint8_t gc_execute_line(char *line)
{
  ...
  { // Loop until no more g-code words in line.
      ...
      case 53:
        ...
        case 30:
          ...
          case 10:
            ...
            break; // G30.1
          default:
            FAIL(STATUS_GCODE_UNSUPPORTED_COMMAND); // [Unsupported G30.x command]
          }
          mantissa = 0; // Set to zero to indicate valid non-integer G command.
          break;
        case 53:
        ...
        case 92:
          ...
          case 10:
            ...
            break; // G92.1
          default:
            FAIL(STATUS_GCODE_UNSUPPORTED_COMMAND); // [Unsupported G92.x command]
          }
          mantissa = 0; // Set to zero to indicate valid non-integer G command.
          break;
        }
    ...
    default:
      ...
      case 'E':
        word_bit = WORD_E;
        gc_block.values.xyz[E_AXIS] = value;
        axis_words |= (1 << E_AXIS);
        break;
      default:
        FAIL(STATUS_GCODE_UNSUPPORTED_COMMAND);
  ...
  */
  ...
  if (axis_command)
  {
    bit_false(value_words, (bit(WORD_X) | bit(WORD_Y) | bit(WORD_Z) | bit(WORD_E)));
  } // Remove axis words.
  if (value_words)
  {
  ...
  */
  ...
  { // Indicates a change.
    ...
    if (gc_state.modal.tool_length == TOOL_LENGTH_OFFSET_ENABLE_DYNAMIC)
    { // G43.1
